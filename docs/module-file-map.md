...
app/cpy/CVACT01Y.cpy = accounts, batch-processing, reports
...
app/cpy/CVACT03Y.cpy = credit-cards, accounts, batch-processing
app/data/EBCDIC/AWS.M2.CARDDEMO.CARDDATA.PS = credit-cards
app/data/EBCDIC/AWS.M2.CARDDEMO.CARDXREF.PS = credit-cards, accounts
...
app/cpy/CVTRA03Y.cpy = transactions, reports, transaction-type-db2
app/cpy/CVTRA04Y.cpy = transactions, reports
...
app/jcl/COMBTRAN.jcl = reports, batch-processing
...
app/cpy-bms/COADM01.CPY = authentication, user-management
...
app/cbl/CBACT02C.cbl = batch-processing, accounts
app/cbl/CBACT03C.cbl = batch-processing, accounts
app/cbl/CBACT04C.cbl = batch-processing, accounts
app/cbl/CBCUS01C.cbl = batch-processing, accounts
...
app/data/EBCDIC/AWS.M2.CARDDEMO.DISCGRP.PS = batch-processing, accounts
app/data/EBCDIC/AWS.M2.CARDDEMO.TCATBALF.PS = batch-processing, transactions
app/data/EBCDIC/AWS.M2.CARDDEMO.EXPORT.DATA.PS = batch-processing
app/cpy/COCOM01Y.cpy = authentication, accounts, credit-cards, transactions, bill-payment, reports, user-management, batch-processing
...
app/cpy/CSMSG01Y.cpy = accounts, transactions, batch-processing
app/cpy/CSMSG02Y.cpy = accounts, transactions, batch-processing
app/cpy/CSSTRPFY.cpy = batch-processing
app/cpy/CSSETATY.cpy = batch-processing
app/cpy/CSLKPCDY.cpy = batch-processing
app/cpy/COTTL01Y.cpy = accounts, transactions, reports
app/cpy/CUSTREC.cpy = accounts, reports
app/cpy/CVCUS01Y.cpy = accounts
...
app/app-transaction-type-db2/ddl/TRNTYPE.ddl = transaction-type-db2, transactions
app/app-transaction-type-db2/ddl/TRNTYCAT.ddl = transaction-type-db2, transactions
app/app-transaction-type-db2/ddl/XTRNTYPE.ddl = transaction-type-db2
app/app-transaction-type-db2/ddl/XTRNTYCAT.ddl = transaction-type-db2
app/app-transaction-type-db2/dcl/** = transaction-type-db2
app/app-transaction-type-db2/ctl/** = transaction-type-db2, batch-processing
...
app/app-vsam-mq/csd/CRDDEMOM.csd = mq-integration
<!-- MODULE_FILE_MAP_END -->
